...
/*     */  
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        setVisible(false);
/* 151 */     new R().setVisible(true);
    }//GEN-LAST:event_jButton2ActionPerformed

    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       try {
/* 125 */       String u = this.jTextField1.getText();
/* 126 */       String p = new String(this.jPasswordField1.getPassword());
/*     */ 
/* 128 */       ResultSet rs = stmt.executeQuery("select s.password from login s where s.username='" + u + "' ");
/* 129 */       rs.next();
/* 130 */       if (rs.getRow() == 0) {
/* 131 */         JOptionPane.showMessageDialog(null, "User Not Found");
/*     */       }
/* 134 */       else if (p.equals(rs.getString(1)))
/*     */       {
/* 136 */         current = u;
/* 137 */         setVisible(false);
/* 138 */         new M().setVisible(true);
/*     */       }
/*     */       else
/*     */       {
/* 142 */         JOptionPane.showMessageDialog(null, "Invalid Login Details");
/*     */       }
/*     */     }
/*     */     catch (Exception e) {
/* 146 */       JOptionPane.showMessageDialog(null, e);
/*     */     }
